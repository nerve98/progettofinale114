...
public class DaoMoto implements IDao<Long, Moto>{
    ...
    public Long create(Moto e) {
       ...
       return db.executeDML(query, String.valueOf(e.getCilindrata()),String.valueOf(e.getCapacitaSerbatoio()),String.valueOf(e.getPotenzaCV()),String.valueOf(e.getPotenzaKV()),String.valueOf(e.getPeso()),String.valueOf(e.getAltezzaSella()),String.valueOf(e.getConsumo()),
       String.valueOf(e.getPrezzo()),String.valueOf(e.isElettronico()),String.valueOf(e.isTrasmissioneM()),e.getEuro(),e.getNomeMotore(),e.getMarca(),e.getTipoMoto(),e.getColoreMoto(),e.getTarga(),String.valueOf(e.getAnnoProduzione()));
    ...
    public void update(Moto e) {
        ...
        db.executeDML(query, String.valueOf(e.getCilindrata()),String.valueOf(e.getCapacitaSerbatoio()),String.valueOf(e.getPotenzaCV()),String.valueOf(e.getPotenzaKV()),String.valueOf(e.getPeso()),String.valueOf(e.getAltezzaSella()),String.valueOf(e.getConsumo()),
        String.valueOf(e.getPrezzo()),String.valueOf(e.isElettronico()),String.valueOf(e.isTrasmissioneM()),e.getEuro(),e.getNomeMotore(),e.getMarca(),e.getTipoMoto(),e.getColoreMoto(),e.getTarga(),String.valueOf(e.getAnnoProduzione()),String.valueOf(e.getId()));
    }
